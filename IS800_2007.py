print("IS800_2007 loaded from:", __file__)
...
class IS800_2007(object):
    ...
    def cl_7_5_1_2_equivalent_slenderness_ratio_of_truss_compression_members_loaded_one_leg(length, r_min, b1, b2, t, f_y, bolt_no = 2, fixity = 'Fixed'):
        ...
        if bolt_no >= 2:
            if fixity == 'Fixed':
                ...
                temp = IS800_2007.cl_7_5_1_2_equivalent_slenderness_ratio_of_truss_compression_members_loaded_one_leg(length, r_min, b1, b2, t, f_y, bolt_no , fixity = 'Fixed')
                temp2 = IS800_2007.cl_7_5_1_2_equivalent_slenderness_ratio_of_truss_compression_members_loaded_one_leg(length, r_min, b1, b2, t, f_y, bolt_no , fixity = 'Hinged')
                k1 = (temp[3] +temp2[3]) /2
                k2 = (temp[4] +temp2[4]) /2
                k3 = (temp[5] +temp2[5]) /2
            ...
            if fixity == 'Fixed':
                ...
                temp = IS800_2007.cl_7_5_1_2_equivalent_slenderness_ratio_of_truss_compression_members_loaded_one_leg(length,
                                                                                                           r_min, b1,
                                                                                                           b2, t, f_y,
                                                                                                           bolt_no,
                                                                                                           fixity='Fixed')
                temp2 = IS800_2007.cl_7_5_1_2_equivalent_slenderness_ratio_of_truss_compression_members_loaded_one_leg(length,
                                                                                                            r_min, b1,
                                                                                                            b2, t, f_y,
                                                                                                            bolt_no,
                                                                                                            fixity='Hinged')
    ...
    def cl_10_3_3_bolt_shear_capacity(f_ub, A_nb, A_sb, n_n, n_s=0, safety_factor_parameter=None):
        ...
        gamma_mb = IS800_2007.cl_5_4_1_Table_5()['gamma_mb'].get(
        safety_factor_parameter.lower() if safety_factor_parameter else KEY_DP_FAB_SHOP,
        IS800_2007.cl_5_4_1_Table_5()['gamma_mb'][KEY_DP_FAB_SHOP]
    )
        V_dsb = V_nsb / gamma_mb
        return V_dsb
    
    @staticmethod
    def cl_5_4_1_Table_5():
        return {
            'gamma_m0': {'Tension': 1.10, 'Compression': 1.10},
            'gamma_m1': {'Tension': 1.25, 'Compression': 1.25},
            'gamma_mb': {KEY_DP_FAB_SHOP: 1.25, KEY_DP_FAB_FIELD: 1.50}
        }
